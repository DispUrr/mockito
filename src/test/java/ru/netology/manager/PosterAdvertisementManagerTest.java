...
public class PosterAdvertisementManagerTest {
    private PosterAdvertisementManager manager = new PosterAdvertisementManager();
    ...
    void shouldReturnMoviesWithMoviesToReturned() {
        PosterAdvertisementManager manager = new PosterAdvertisementManager(5);
    ...
    void shouldReturnLastFourIfMoviesToReturnSix() {
        PosterAdvertisementManager manager = new PosterAdvertisementManager(6);
    ...
    void shouldReturnEmptyArrayIfAddMoviesAndMoviesToReturnZero() {
        ...
        manager.add(second);
        manager.add(third);
        PosterAdvertisementManager manager = new PosterAdvertisementManager(0);
    ...
    void shouldReturnDefaultIfLessZero() {
        manager = new PosterAdvertisementManager(-4);
        manager.add(first);
        manager.add(second);
        manager.add(third);
        manager.add(fourth);
